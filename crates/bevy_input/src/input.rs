    ...
    T: Clone + Eq + Hash + Send + Sync + 'static,
{
    ...
    pub fn any_pressed<I: Into<T>>(&self, inputs: impl IntoIterator<Item = I>) -> bool {
    ...
    pub fn any_just_pressed<I: Into<T>>(&self, inputs: impl IntoIterator<Item = I>) -> bool {
    ...
    pub fn clear_just_pressed<I: Into<T>>(&mut self, input: I) -> bool {
    ...
    pub fn any_just_released<I: Into<T>>(&self, inputs: impl IntoIterator<Item = I>) -> bool {
    ...
    pub fn reset<I: Into<T>>(&mut self, input: I) {
        let input = input.into();
...
mod test {
    ...
    #[test]
    fn test_press() {
        let mut input = Input::<DummyInput>::default();
